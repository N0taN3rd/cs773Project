...
\lstinputlisting[
frame=single,
caption={Task vii NaiveBayes Output},label=lst:vii_nb,captionpos=b,numbers=left]{../q7-Yun/nb.txt}

\lstinputlisting[
frame=single,
caption={Task vii J48 Output},label=lst:vii_j48,captionpos=b,numbers=left]{../q7-Yun/j48.txt}
\clearpage
\newpage
\section*{Task viii}
\addcontentsline{toc}{section}{Task viii}
\index{Task viii}
\begin{verbatim}
...
\lstinputlisting[
frame=single,
caption={Task viii J48 Output},label=lst:viii_j48,captionpos=b,numbers=left]{../q8-Yun/q8output.txt}
\clearpage
\newpage
\begin{appendices}
...
\lstinputlisting[language=Perl,
frame=single,
caption={Task vii Perl script},label=lst:vii,captionpos=b,numbers=left]{../q7-Yun/q7.pl}
\lstinputlisting[language=Perl,
frame=single,
caption={Task viii Perl script},label=lst:viii,captionpos=b,numbers=left]{../q8-Yun/q8.pl}
